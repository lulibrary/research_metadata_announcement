...
class TestTransformationDataset < Minitest::Test
  ...
  def test_dataset_1
    ...
    id = 'a57aebd2-d984-4bf4-a687-bb34d691a4fc'
    transformer = make_transformer :dataset
    announcement = transformer.transform uuid: id, composition: [:new, :title, :uri]
  ...
  def test_dataset_2
    ...
    id = 'f61d1377-02ca-4c60-94bc-2fe9e37de51c'
    transformer = make_transformer :dataset
    announcement = transformer.transform uuid: id, composition: [:uri, :title]
  ...
  def test_dataset_3
    ...
    id = 'a6a03e05-d762-4032-8f6f-8816d6d4ca3d'
    transformer = make_transformer :dataset
    announcement = transformer.transform uuid: id, composition: [:keywords, :uri]
  ...
  def test_dataset_4
    ...
    id = 'e44cbfa2-91e2-4548-992a-bfd47a3138e8'
    transformer = make_transformer :dataset
    announcement = transformer.transform uuid: id, composition: [:hashtags, :uri]
  ...
  def test_dataset_5
    ...
    id = 'ca47ec2d-fc71-46e0-9a6d-c720bac652c2'
    transformer = make_transformer :dataset
    announcement = transformer.transform uuid: id, composition: [:uri, :keywords]
  ...
  def test_dataset_6
    ...
    id = 'a762a8a2-a9ed-4abb-ba91-a67752b1c54d'
    transformer = make_transformer :dataset
    announcement = transformer.transform uuid: id, composition: [:uri, :hashtags], max_descriptors: 4
